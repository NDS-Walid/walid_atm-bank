...
function CMenu:drawMenuButton(button, intX, intY, boolSelected, intW, intH, intID)
	...
	local tableColor, add, currentMenuData = boolSelected and (button.colorSelected or { 5, 0, 195, 125 }) or (button.colorFree or { 0, 0, 0, 100 }), .0, self.Menu[self.Data.currentMenu]

	DrawRect(intX, intY, intW, intH, tableColor[1], tableColor[2], tableColor[3], tableColor[4])

	tableColor = boolSelected and {0, 0, 0} or {196, 199, 191}
